...
class VAEArith:
    ...
    def __init__(self, x_dimension, z_dimension=100, **kwargs):
        ...
        self.init_w = tf.keras.initializers.glorot_normal()
    ...
    def predict(self, adata, adata1, conditions, cell_type_key, condition_key, adata_to_predict=None, celltype_to_predict=None,
        ...
        if celltype_to_predict is not None:
            ctrl_pred = extractor(adata1, celltype_to_predict, conditions, cell_type_key, condition_key)[1]
        else:
